...
export default function Auth() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center gradient-sentinel relative">
      ...
      <div className="w-full max-w-md p-8 animate-fade-in-up">
        ...
        <div className="glass-panel rounded-lg p-6 glow-cyan animate-scale-in">
